    ...
    <div id="homecontent">
		<div class="all_left">
            ...
            <p class="readmore"> <?php echo "上传时间：".$row['Time'];?></p>
				<div class="play">
				<p class="readmore">
				<a href="#VideoWin" class="show" name="<?php echo $row['videoname'];?>">播放 &raquo;</a>
                <a href="#VideoWin" class="hide" name="<?php echo $row['videoname'];?>">收起 &raquo;</a>
				</p>
				</div>
		...
		<!--video-->
            ...
            <p class="readmore">
				...
				<a href="videocontrol.php" class="show" name="">视频管理&raquo;</a>
			</p>
			<?php
            }
			?>
